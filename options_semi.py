...
class Options:
    def __init__(self, isTrain):
        ...
        # --- training params --- #
        self.train = dict()
        self.train['data_dir'] = './data/SemiData/{:s}'.format(self.dataset)  # path to data
        self.train['save_dir'] = './experiments/{:s}/1'.format(self.dataset)
        self.train['input_size'] = (416, 416)   # input size of the image
        self.train['num_epochs'] = 1000 if self.dataset == 'GlaS_0.125' else 300  # number of training epochs
        self.train['batch_size'] = 8     # batch size
        self.train['val_overlap'] = 80   # overlap size of patches for validation
        self.train['lr'] = 0.0005 if self.dataset == 'GlaS_0.125' else 0.001       # initial learning rate
        ...
        self.train['gpu'] = []        # select gpu devices
        ...
        self.test['patch_size'] = 416 if self.dataset == 'GlaS_0.125' else 208
        ...
        # --- post processing --- #
        self.post = dict()
        self.post['min_area'] = 1290 if self.dataset == 'GlaS_0.125' else 20  # minimum area for an object
        self.post['radius'] = 3 if self.dataset == 'GlaS_0.125' else 2
